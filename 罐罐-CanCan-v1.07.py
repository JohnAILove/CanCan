    ...
    def copy_to_clipboard(self, event):
        ...
        try:
            ...
            if message_content:
                ...
                messagebox.showinfo("已複製", "訊息已複製到剪貼板。")  # 新增的代碼
        except tk.TclError:
            pass
